package instagram.activity 
{
	...
	[Embed(source="../../../lib/assets.swf", symbol="instagram.activity.SearchActivity")]
	public class SearchActivity extends Activity
	{
		...
		protected override function onStart(e:Event):void
		{
			...
			Container.current.NotifyUserActivity("Страница поиска в instagramm.");		
		...
		{
			startActivity(new ViewActivity(new AttributeSet( { view_type : search_text.substr(0, 1) == "#" ? "#" : "@", view_text: search_text.substr(0, 1) == "#" ? search_text.substr(1) : search_text.substr(0, 1) == "@" ? search_text.substr(1) : search_text, title: search_text.substr(0, 1) == "#" ? "Найденные хэш-теги: #" + search_text.substr(1) : "Найденные пользователи: " + search_text} )));
		}		
	}
